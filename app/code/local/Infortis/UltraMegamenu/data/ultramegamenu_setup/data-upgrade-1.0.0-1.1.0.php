...
$installer->addAttribute('catalog_category', 'umm_dd_type', array(
	...
	//'input_renderer'		=> '',
	//'frontend_class'		=> '',
	'source'				=> 'ultramegamenu/category_attribute_source_dropdown_type', //COPY FILE
...
$installer->addAttribute('catalog_category', 'umm_dd_proportions', array(
	...
	'note'					=> 'Proportions between sections of drop-down box: Left Block, subcategories, Right Block. Enter value in grid units. For each section enter a number between 1 and 12. Sum of the grid units entered for all three sections has to be equal 12.',

	'backend'				=> 'ultramegamenu/category_attribute_backend_grid_columns',
	'type'					=> 'varchar',
	'frontend'				=> '',
	'input'					=> 'text',
	////'input_renderer'		=> 'infortis_infortis_lib_data_form_element_grid_columns',
